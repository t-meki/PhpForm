...
<body style="background-color : #AAEEDD">
    ...
    <table>
        <tr>
            ...
            <td>
                <?php
                    $counter_file1 = 'counter1.txt';
                    $counter_file2 = 'contact_log1.txt';
                    $counter_lenght = 8;

                    $fp1 = fopen($counter_file1, 'r+');
                    $fp2 = fopen($counter_file2, 'a+');
